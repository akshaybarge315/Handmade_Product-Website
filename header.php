            ...
            <div class="col-md-2">
                <?php
                    if(!empty($header[0]['site_logo'])){ ?>
                        <a href="<?php echo $hostname; ?>" class="logo-img"><img src="https://cdn.statically.io/img/authindia.com/wp-content/uploads/2019/09/Authindia-LOGO_white.png?quality=70&f=auto" alt=""></a>
                    <?php }else{ ?>
